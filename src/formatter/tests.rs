...
mod tests {
    ...
    use crate::{
        ...
        Node, NodeByte, NodeByteFactory, NodeFactory, SimpleType, Term, TermFactory,
    };

    /// Helper to create a simple term: P → Q
    fn create_simple_term() -> EnumTerm<SimpleType, MetaByte, NodeByte> {
        let term_factory: EnumTermFactory<SimpleType, MetaByte, NodeByte> =
            EnumTermFactory::new();
        let metavar_factory = MetaByteFactory();
        let node_factory: NodeByteFactory<SimpleType> = NodeByteFactory::new();

        let p = metavar_factory
            .create("P", &SimpleType::Boolean)
            .unwrap();
        let q = metavar_factory
            .create("Q", &SimpleType::Boolean)
            .unwrap();
        ...
        term_factory.create_node(implies, vec![p_term, q_term]).unwrap()
    }
    ...
    #[test]
    fn test_color_formatters_provide_colors() {
        let utf8_color_fmt = get_formatter("utf8-color");
    ...
    #[test]
    fn test_metabyte_ascii_formatting() {
        let metavar_factory = MetaByteFactory();
        let p = metavar_factory
            .create("P", &SimpleType::Boolean)
            .unwrap();
    ...
    #[test]
    fn test_metabyte_utf8_formatting() {
        let metavar_factory = MetaByteFactory();
        let p = metavar_factory
            .create("P", &SimpleType::Boolean)
            .unwrap();
    ...
    #[test]
    fn test_nodebyte_ascii_formatting() {
        let node_factory: NodeByteFactory<SimpleType> = NodeByteFactory::new();
        let implies = node_factory.create_by_name("Implies", 2).unwrap();
    ...
    #[test]
    fn test_nodebyte_utf8_formatting() {
        let node_factory: NodeByteFactory<SimpleType> = NodeByteFactory::new();
        let implies = node_factory.create_by_name("Implies", 2).unwrap();
    ...
    #[test]
    fn test_nodebyte_latex_formatting() {
        let node_factory: NodeByteFactory<SimpleType> = NodeByteFactory::new();
        let implies = node_factory.create_by_name("Implies", 2).unwrap();
    ...
    #[test]
    fn test_complex_term_formatting() {
        // Build: (P ∧ Q) → R
        let term_factory: EnumTermFactory<SimpleType, MetaByte, NodeByte> =
            EnumTermFactory::new();
        let metavar_factory = MetaByteFactory();
    ...
    #[test]
    fn test_unary_operator_formatting() {
        // Build: ¬P
        let term_factory: EnumTermFactory<SimpleType, MetaByte, NodeByte> =
            EnumTermFactory::new();
        let metavar_factory = MetaByteFactory();
